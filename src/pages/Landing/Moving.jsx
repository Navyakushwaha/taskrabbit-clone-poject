...
import HomepageImage from "../../assets/Images/Homepage_Moving.webp";
import "./Landing.css"
            ...
            <Container maxWidth="full" sx={{ height: { xs: 'auto', sm: 'auto', md: 'auto' } }}>
                ...
                <Box sx={{ position: "relative", height: { xs: 'auto', sm: 'auto', md: 'auto' }, width: { xs: 'auto', sm: '100%', md: '100%' }, }}>
                    <Box sx={{
                        ...
                        <Typography variant="h5" sx={{ mt: { xs: '10px', md: "25px", sm: '20px' } }}>Moving</Typography>
                        <Box sx={{ height: 'auto', width: '100%', mt: { xs: '10px', md: "20px", sm: '20px' }, lineHeight: '23px' }}>
                            <Typography variant="p" sx={{ fontSize: '17px' }}>Moving help such as packing/unpacking, loading, and lifting heavy items..</Typography><br />
                        </Box>
                        <Box sx={{ height: 'auto', width: '100%', mt: { xs: '10px', md: "30px", sm: '30px' }, lineHeight: '23px' }}>
                            <Typography variant="p" sx={{ fontSize: '17px' }}>Now Trending: Single-item moves, apartment moves, and junk removal.</Typography>
                        </Box>
                    ...
                    <Box sx={{
                        ...
                        , background: "#eaf5e3ff", borderRadius: '10px', px: { xs: 'auto', md: "120px", sm: '120px' }, py: { xs: 'auto', md: "60px", sm: '60px' }
                    }}>
