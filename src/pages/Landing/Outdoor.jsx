...
import HomepageImage from "../../assets/Images/Homepage_Outdoor.webp";
import "./Landing.css"
                ...
                <Box sx={{ position: "relative", height: { xs: 'auto', sm: 'auto', md: 'auto' }, width: { xs: 'auto', sm: '100%', md: '100%' }, }}>
                    <Box sx={{
                        ...
                        <Box sx={{ height: 'auto', width: '100%', mt: { xs: '10px', md: "20px", sm: '20px' }, lineHeight: '23px' }}>
                            <Typography variant="p" sx={{ fontSize: '17px' }}>Get fall-ready with leaf removal, gutter cleaning, and hedge trimming to prep your yard for the season.</Typography><br />
                        </Box>
                        <Box sx={{ height: 'auto', width: '100%', mt: { xs: '10px', md: "30px", sm: '30px' }, lineHeight: '23px' }}>
                            <Typography variant="p" sx={{ fontSize: '17px' }}>Now Trending: Leaf raking, gutter cleaning, yard debris removal, and seasonal landscaping.N</Typography>
                        </Box>
                    ...
                    <Box sx={{
                        ...
                        , background: "#eef5e3ff", borderRadius: '10px', px: { xs: 'auto', md: "120px", sm: '120px' }, py: { xs: 'auto', md: "60px", sm: '60px' }
                    }}>
