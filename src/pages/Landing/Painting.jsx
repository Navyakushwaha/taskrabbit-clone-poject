...
import HomepageImage from "../../assets/Images/Homepage_Painting.webp";
import "./Landing.css"
          ...
          <Container maxWidth="full" sx={{ height: { xs: 'auto', sm: 'auto', md: 'auto' } }}>
                          <Box sx={{
                           ...
                           <Box sx={{position:"relative",height: { xs: 'auto', sm: 'auto', md: 'auto' },width: { xs: 'auto', sm: '100%', md: '100%'},}}>
                              ...
                              <Typography variant="h5" sx={{mt:{xs:'10px',md:"25px",sm:'20px'}}}>Painting</Typography>
                              <Box sx={{height:'auto',width:'100%' ,mt:{xs:'10px',md:"20px",sm:'20px'},lineHeight:'23px'}}>
                                  <Typography variant="p" sx={{fontSize:'17px'}}>Paint walls, ceilings, molding, and doors; includes prep and cleanup.</Typography><br/>
                              </Box>
                              <Box sx={{height:'auto',width:'100%',mt:{xs:'10px',md:"30px",sm:'30px'},lineHeight:'23px'}}>
                                  <Typography variant="p" sx={{fontSize:'17px'}}>Now Trending: Color blocking, stripe details, and statement colors.</Typography>
                              </Box>
